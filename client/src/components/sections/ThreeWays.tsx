...
import { Video, ShoppingBag, MessageSquareText, ArrowRight } from "lucide-react";
  ...
  return (
    <div ref={container} className="h-screen flex items-center justify-center sticky top-0">
      <motion.div 
        ...
        className="relative flex flex-col md:flex-row h-[500px] w-full rounded-[3rem] border border-white/10 bg-[#0A0A0A] overflow-hidden origin-top shadow-2xl"
      >
        {/* Content Side */}
        ...
        <div className="flex-1 relative overflow-hidden">
           ...
           <div className="absolute inset-0 p-8 flex items-end justify-end">
              <div className="bg-black/40 backdrop-blur-xl border border-white/10 p-4 rounded-2xl flex items-center gap-4">
                 ...
                 <span className="text-white font-mono text-xs">LIVE DEMO</span>
              </div>
           </div>
        </div>
      </motion.div>
